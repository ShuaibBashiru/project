...
<div class="col-md-12 p-0 border-bottom border-top border-start">
    ...
    <div class="row">
        <div class="col-md-12"><h5 class="text-center">Performance Classification model(Multi-criterial Decision making(Fuzzy))</h5></div>
        <div class="col-md-12">
...
<div class="col-md-12 p-0 border-bottom border-top border-start">
    ...
    <div class="row">
        <div class="col-md-4 p-3 justify-content-center">
            <h4 class="lead mt-5  text-center">Performance Chart</h4> 
            <p class="lead mt-5 text-center"><strong>Result showing</strong></p> 
        </div>
    ...
    methods:{
           ...
           visualize(){
            ...
            params: {
                ...
                this.classname='alert alert-danger p-1 text-center'
                this.alert='Error: Request failed, Please try again' 
