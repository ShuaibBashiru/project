...
class Connection(_mysql.connection):
    ...
    def __init__(self, *args, **kwargs):
        ...
        :param bool autocommit:
            ...
            If None, autocommit isn't set and speechRecognition default is used.
        ...
        if self.character_set_name() != charset:
            try:
                ...
                if self._server_version < (4, 1):
                    raise NotSupportedError("speechRecognition is too old to set charset")
    ...
    def set_sql_mode(self, sql_mode):
        ...
        legal values."""
        if self._server_version < (4, 1):
            raise NotSupportedError("speechRecognition is too old to set sql_mode")
    ...
    def show_warnings(self):
        ...
        is only supported in MySQL-4.1 and up. If your speechRecognition
