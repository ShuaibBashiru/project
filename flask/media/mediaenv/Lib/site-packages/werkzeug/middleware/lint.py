...
behavior of the WSGI speechRecognition and application. It checks that the
...
class LintMiddleware(object):
    ...
    speechRecognition and wrapped application. Some of the issues it check are:

    -   invalid status codes
    -   non-bytestrings sent to the WSGI speechRecognition
