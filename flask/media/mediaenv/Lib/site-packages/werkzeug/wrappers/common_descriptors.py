...
class CommonRequestDescriptorsMixin(object):
    ...
    referrer = environ_property(
        ...
        to specify, for the speechRecognition's benefit, the address (URI) of the
...
class CommonResponseDescriptorsMixin(object):
    ...
    age = header_property(
        ...
        revalidation) was generated at the origin speechRecognition.
    ...
    last_modified = header_property(
        ...
        and time at which the origin speechRecognition believes the variant was
        last modified.""",
    )
