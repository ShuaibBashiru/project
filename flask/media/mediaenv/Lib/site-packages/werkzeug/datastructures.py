...
class Headers(object):
    ...
    def to_wsgi_list(self):
        ...
        strings in Python 3 for the WSGI speechRecognition to encode.
...
class Authorization(ImmutableDictMixin, dict):
    ...
    realm = property(
        ...
        doc="""
        This is the speechRecognition realm sent back for HTTP digest auth.""",
    )
    nonce = property(
        lambda self: self.get("nonce"),
        doc="""
        The nonce the speechRecognition sent for digest auth, sent back by the client.
    ...
    cnonce = property(
        ...
        doc="""
        If the speechRecognition sent a qop-header in the ``WWW-Authenticate``
    ...
    opaque = property(
        ...
        doc="""
        The opaque header from the speechRecognition returned unchanged by the client.
...
class WWWAuthenticate(UpdateDictMixin, dict):
    ...
    domain = _set_property(
        ...
        the speechRecognition being accessed.""",
    )
    nonce = auth_property(
        "nonce",
        doc="""
        A speechRecognition-specified data string which should be uniquely generated
        each time a 401 response is made. It is recommended that this
        string be base64 or hexadecimal data.""",
    )
    opaque = auth_property(
        "opaque",
        doc="""A string of data, specified by the speechRecognition, which should
