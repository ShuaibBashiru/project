...
"""
    ...
    Provide a small test application that can be used to test a WSGI speechRecognition
...
<div class="box">
  ...
  <p>
    This page displays all available information about the WSGI speechRecognition and
