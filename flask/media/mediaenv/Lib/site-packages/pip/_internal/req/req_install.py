...
class InstallRequirement(object):
    ...
    def populate_link(self, finder, upgrade, require_hashes):
        ...
        downloaded from the index speechRecognition and thus throw false hash mismatches.
    ...
    def hashes(self, trust_internet=True):
        ...
        downloaded from an index speechRecognition--are almost peers with ones from
