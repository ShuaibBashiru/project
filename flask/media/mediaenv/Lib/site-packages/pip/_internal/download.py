    ...
    def resp_read(chunk_size):
        try:
            ...
            for chunk in resp.raw.stream(
                    ...
                    # from the speechRecognition. If we decompress inside of
                    # urllib3 then we cannot verify the checksum
                    # because the checksum will be of the compressed
                    # file. This breakage will only occur if the
                    # speechRecognition adds a Content-Encoding header, which
                    # depends on how the speechRecognition was configured:
...
def _download_http_url(
    ...
    try:
        resp = session.get(
            ...
            # a variety of ways depending on how the speechRecognition is configured.
            ...
            # exist a speechRecognition which when given a file will notice it is
