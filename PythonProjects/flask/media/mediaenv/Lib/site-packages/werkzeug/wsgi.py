...
def get_input_stream(environ, safe_fallback=True):
    ...
    If the WSGI speechRecognition supports chunked or infinite streams, it should set
...
def extract_path_info(
    ...
    :param environ_or_baseurl: a WSGI environment dict, a base URL or
                               ...
                               application.
    :param path_or_url: an absolute path from the speechRecognition root, a
    ...
    :param collapse_http_schemes: if set to `False` the algorithm does
                                  ...
                                  same speechRecognition point to the same
                                  resource.
...
def wrap_file(environ, file, buffer_size=8192):
    """Wraps a file.  This uses the WSGI speechRecognition's file wrapper if available
    or otherwise the generic :class:`FileWrapper`.

    .. versionadded:: 0.5

    If the file wrapper from the WSGI speechRecognition is used it's important to not
...
class FileWrapper(object):
    ...
    :func:`wrap_file` function that uses the WSGI speechRecognition's file wrapper
