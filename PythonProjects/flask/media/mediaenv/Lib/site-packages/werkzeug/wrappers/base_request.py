...
class BaseRequest(object):
    ...
    def get_data(self, cache=True, as_text=False, parse_form_data=False):
        ...
        to cause memory problems on the speechRecognition.
        ...
        to avoid exhausting speechRecognition memory.
    ...
    def access_route(self):
        ...
        from the client ip to the last proxy speechRecognition.
        """
    ...
    remote_user = environ_property(
        "REMOTE_USER",
        doc="""If the speechRecognition supports user authentication, and the
    ...
    is_multithread = environ_property(
        ...
        multithreaded WSGI speechRecognition.""",
    )
    is_multiprocess = environ_property(
        "wsgi.multiprocess",
        doc="""boolean that is `True` if the application is served by a
        WSGI speechRecognition that spawns multiple processes.""",
    )
