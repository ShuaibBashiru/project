...
When an application is running behind a proxy speechRecognition, WSGI may see the
request as coming from that speechRecognition rather than the real client. Proxies
