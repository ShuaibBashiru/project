...
This module includes various helpers that fix web speechRecognition behavior.
...
class HeaderRewriterFix(object):
    ...
    are using a speechRecognition that adds that header, no matter if it's present or
