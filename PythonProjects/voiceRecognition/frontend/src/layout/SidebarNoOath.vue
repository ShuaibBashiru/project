...
<div class="row">
  ...
  <li class="list-group-item"><router-link class="" to="/oath/enroll">Enroll voice</router-link></li>
  <li class="list-group-item"><router-link class="" to="/oath/compare">Compare voice</router-link></li>
</ul>
       <!-- layer one -->
    </div>
