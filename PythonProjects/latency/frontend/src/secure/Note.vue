...
<div class="input-group justify-content-end">
 <button class="btn btn-secondary m-1 mb-0" @click="checkForm">Summarize</button>
...
<div class="col-md-12 p-0">
    <div class="row">
        <div class="col-md-6">
           <p class="lead p-0 m-0 text-center bg-primary text-white">Notes {{originalLenght}}</p>
        </div>

        <div class="col-md-6 border-start">
         <p class="lead p-0 m-0 text-center bg-secondary text-white">Summary {{summaryLenght}}</p>
        </div>
    </div>
    </div>
</div>
