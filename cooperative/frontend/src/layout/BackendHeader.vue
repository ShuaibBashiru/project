...
<div class="row">
    <div class="col-md-2 sidebar p-2 border-end" :style="appinfo.css.sidebarbg">
      ...
      <ul class="list-group mt-2 list-group-flush">
        <li class="list-group-item active border"><router-link to="/secure/dashboard" class="text-white"><i class="bi-list" style="font-size: 1.2rem; color: #fff;"></i> Dashboard </router-link></li>
      </ul>
