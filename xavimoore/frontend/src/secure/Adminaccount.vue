...
<div class="p-1 pb-0 ml-0 pl-0">
    <h5 class="mt-2 text-primary"><i class="bi-person-plus" style="font-size: 1.5rem;"></i> Admin's Account</h5>
</div>
</div>
...
<div class="btn-group m-2" role="group" aria-label="First group"><router-link to="/oath/adminrecord" class="btn btn-primary text-center">  <i class="bi-person-circle"></i> Save </router-link></div>
<div class="btn-group m-2" role="group" aria-label="First group"><router-link to="/oath/adminrecord" class="btn btn-primary text-center">  <i class="bi-person-circle"></i> Accounts </router-link></div>
