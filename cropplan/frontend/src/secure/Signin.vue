...
<div class="row">
  ...
  <div class="col-md-6 d-flex justify-content-end">
   <a href="oath/forgot" class="text-right">
      ...
      <div class="form-group mt-4 col">
     <button type="submit" name="signin" class="btn btn-danger form-control">Sign in</button>
    </div>
...
tokenize: function(){
            ...
            fd.append('token', Math.random(9,99999))
            axios.get('http://127.0.0.1:8000/api_auth/tokenize/',
             fd,{
             headers: {
          // remove headers
             }
       ...
       signIn(){
              ...
              // };
              axios.post('http://127.0.0.1:8000/api_auth/sign_in/23/', fd)
              .then(response => {
                if(response.data.status==response.data.confirmed){
