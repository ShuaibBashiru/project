...
<div class="row">
    <div class="col-md-12  border border-top-0 border-right-0 border-left-0 header">
            ...
            <a class="navbar-brand" href="/oath/dashboard"><img src="" alt=" " class="site_logo"> &nbsp; {{appinfo.appname}}</a>
  ...
  <li class="list-group-item"><router-link class="" to="/oath/traindata">Model and Output</router-link></li>
</ul>
       <!-- layer one -->
    </div>
</div>
