...
<div class="row">
    ...
    <li class="list-group-item active"><router-link to="/oath/dashboard" class="text-white">Benchmark Functions</router-link></li>
  <li class="list-group-item"><router-link class="" to="/oath/function_one">Functions</router-link></li>
