...
<div class="row">
    <div class="col-md-12  border border-top-0 border-right-0 border-left-0 header">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <ul class="navbar-nav m-0 p-0 ms-auto">
                    <li class="nav-item"> <a class="nav-link" target="_blank" href="/page/contactus">Help(Chat)</a> </li>
                </ul>
            </div>
            </nav>
    </div>
    ...
    <li class="list-group-item active"><router-link to="/oath/dashboard" class="text-white">Dashboard</router-link></li>
    <li class="list-group-item"><router-link class="" to="/oath/compare">Identify Face</router-link></li>
    <li class="list-group-item"><router-link class="" to="/oath/docketverifier">Verify docket</router-link></li>
    <li class="list-group-item"><router-link class="" to="/oath/matricverifier">Verify matric</router-link></li>
    <li class="list-group-item"><router-link class="" to="/oath/uploadcourses">Upload Courses</router-link></li>
  <li class="list-group-item"><router-link class="" to="/oath/enroll">Enrollment</router-link></li>
</ul>
       <!-- layer one -->
    </div>
