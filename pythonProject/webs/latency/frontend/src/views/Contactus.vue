    ...
    <div>
        <div class="container">
            ...
            <div class="row">
                ...
                <a class="nav-link p-0" href="#"><button class="btn btn-primary">Write us a message</button></a>
                </div>
                <div class="col-md-2 mt-4"></div>
                <div class="col-md-5 mt-4">
                    <h3>Mail Us</h3>
                    <p class="lead"></p>
               <a class="nav-link p-0" href="mailto:instructsme@gmail.com">Email: instructsme@gmail.com</a>
