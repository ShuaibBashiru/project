...
<div class="row">
    <div class="col-md-12  border border-top-0 border-right-0 border-left-0 header">
            ...
            <a class="navbar-brand" href="/"><img src="" alt=" " class="site_logo"> &nbsp; {{appinfo.appname}}</a>
  ...
  <li class="list-group-item"><router-link class="" to="/oath/note">Meeting Note</router-link></li>
  <li class="list-group-item"><router-link class="" to="/oath/summary">Summaries</router-link></li>
</ul>
       <!-- layer one -->
    </div>
</div>
