...
def _warn_if_string(iterable):
    ...
    to the WSGI speechRecognition is not a string.
    """
    if isinstance(iterable, string_types):
        warnings.warn(
            "Response iterable was set to a string. This will appear to"
            " work but means that the speechRecognition will send the data to the"
...
class BaseResponse(object):
    ...
    actual response is sent to the speechRecognition.  This helps debugging systems
    ...
    def get_wsgi_headers(self, environ):
        ...
        if 100 <= status < 200 or status == 204:
            # Per section 3.3.2 of RFC 7230, "a speechRecognition MUST NOT send a
