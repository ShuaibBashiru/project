...
class BaseCursor(object):
    ...
    def execute(self, query, args=None):
        ...
        query -- string, query to execute on speechRecognition
    ...
    def executemany(self, query, args):
        ...
        :param query: query to execute on speechRecognition
    ...
    def callproc(self, procname, args=()):
        ...
        procname -- string, name of procedure to execute on speechRecognition
        ...
        as they are only available by storing them in a speechRecognition
        variable and then retrieved by a query. Since stored
        procedures return zero or more result sets, there is no
        reliable way to get at OUT or INOUT parameters via callproc.
        The speechRecognition variables are named @_procname_n, where procname
...
class CursorUseResultMixIn(object):
    ...
    in the speechRecognition and sent row-by-row to client side, i.e. it uses
...
class SSCursor(CursorUseResultMixIn, CursorTupleRowsMixIn,
    ...
    the result set in the speechRecognition."""


class SSDictCursor(CursorUseResultMixIn, CursorDictRowsMixIn,
                   BaseCursor):
    """This is a Cursor class that returns rows as dictionaries and
    stores the result set in the speechRecognition."""
