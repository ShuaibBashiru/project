...
def new_password_mailer(email, business_name, code):
    try:
        ...
        html = """\
          ...
          <h3 style="margin: 0px;">Thank you for choosing Famah </h3>
        ...
        write_error('New email account', e)
        return False
