...
<div class="row">
    <div class="col-md-2 sidebar p-2 border-end">
      ...
      <ul class="navbar-nav sidebar-list mt-4">
        <li class="nav-item active"><router-link to="/secure/dashboard" class="nav-link"><i class="bi-house" style="font-size: 1.1rem; "></i> Home </router-link></li>
        <hr>
    ...
    <li class="nav-item"><router-link :to="'/secure/'+d['menuName']" class="nav-link"><i :class="d['menu_icon']" style="font-size: 0.9rem; color: black;"></i> {{d['menu_description']}} </router-link></li>
   </ul>
</div>
