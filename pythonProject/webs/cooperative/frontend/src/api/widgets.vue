                ...
                <table class="table border" id="myTable">
                    <thead>
                        ...
                        <tr v-for="(d, index) in info" :key="index">
                            ...
                            <td class="text-center"> <a :href="'/secure/updatewidget/'+d['widgetTitle']+'/'+d['id']+'?category='+d['widgetName']"><i class="bi-pencil-square btn p-0 text-primary"></i> </a></td>
                            <td class="text-center"> <a :href="'/secure/deletewidget/'+d['widgetTitle']+'/'+d['id']+'?category='+d['widgetName']"><i class="bi-trash btn p-0 text-danger"></i> </a></td>
                        </tr>
                    </thead>
                </table>
            </div>
...
export default {
    ...
    updateStatus: function(){
        ...
        axios.post('/posts/widget/update_status/', form)
        .then(response => {
