...
id int not null AUTO_INCREMENT,
    ...
    email_one varchar(50) not null UNIQUE,
    ...
    pwd_auth varchar(60) null DEFAULT '',
...
id int not null AUTO_INCREMENT,
    ...
    resetCode varchar(50) not null unique,
...
INSERT INTO `admin_record` (`id`, `surname`, `firstname`, `othername`, `email_one`,
 `email_two`, `phone_one`, `phone_two`, `gender`, `age`, `countryCode`, `language_code`,
  `persional_id`, `account_type`, `user_role`, `pwd_auth_hash`, `pwd_auth`, `status_id`,
  `record_status`, `created_by`, `modified_by`, `date_created`, `time_created`,
  `date_modified`, `time_modified`) VALUES (NULL, 'bashiru', 'shuaib', '', 'instructsme@gmail.com',
  '', '08172790181', '', '', '1', '+234', 'English', '', '', '', '', '', '1', '1', '1', '1',
  '2021-05-15', '14:34:47', '2021-05-15', '14:34:47');

ALTER TABLE `admin_record` ADD `record_status` INT NOT NULL AFTER `status_id`;

INSERT INTO `admin_menus` (`id`, `menuName`, `category`, `menu_icon`,
...
VALUES (NULL, 'dashboard', 'dashboard', 'bi-bricks', 'Dashboard','1431535554124', '1',
'1', '1', '1', '2021-04-13', '10:56:05', '2021-04-13', '10:56:05');

INSERT INTO `admin_menus` (`id`, `menuName`, `category`, `menu_icon`,
`menu_description`, `uniqueCode`, `status_id`, `record_status`, `created_by`,
`modified_by`, `date_created`, `time_created`, `date_modified`, `time_modified`)
VALUES (NULL, 'menus', 'menus', 'bi-bricks', 'Menus', '455435515354124', '1',
'1', '1', '1', '2021-04-13', '10:56:05', '2021-04-13', '10:56:05');

INSERT INTO `admin_menus` (`id`, `menuName`, `category`, `menu_icon`,
`menu_description`, `uniqueCode`, `status_id`, `record_status`, `created_by`,
`modified_by`, `date_created`, `time_created`, `date_modified`, `time_modified`)
VALUES (NULL, 'menu_priviledge', 'menu_priviledge', 'bi-bricks', 'Menu Priviledge','2431535554124', '1',
'1', '1', '1', '2021-04-13', '10:56:05', '2021-04-13', '10:56:05');

INSERT INTO `admin_menus` (`id`, `menuName`, `category`, `menu_icon`,
`menu_description`, `uniqueCode`, `status_id`, `record_status`, `created_by`,
`modified_by`, `date_created`, `time_created`, `date_modified`, `time_modified`)
VALUES (NULL, 'widget', 'widget', 'bi-bricks', 'Widgets','3431535554124', '1',
'1', '1', '1', '2021-04-13', '10:56:05', '2021-04-13', '10:56:05');

INSERT INTO `admin_priviledges` (`id`, `menu_id`, `user_id`,
...
`record_status`, `created_by`, `modified_by`, `date_created`,
  ...
  VALUES (NULL, '1', '1', NULL, '444324213115', '1', '1', '1', '1', '2021-04-07',
...
`record_status`, `created_by`, `modified_by`, `date_created`,
  `time_created`, `date_modified`, `time_modified`)
  VALUES (NULL, '3', '1', NULL, '644324213115', '1', '1', '1', '1', '2021-04-07',
  '11:34:10', '2021-04-07', '11:34:10');
...
`record_status`, `created_by`, `modified_by`, `date_created`,
  `time_created`, `date_modified`, `time_modified`)
  VALUES (NULL, '4', '1', NULL, '744324213115', '1', '1', '1', '1', '2021-04-07',
  '11:34:10', '2021-04-07', '11:34:10');
