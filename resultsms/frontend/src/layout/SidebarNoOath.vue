...
<div class="row">
  ...
  <li class="list-group-item"><router-link class="" to="/oath/uploadresult">Upload result</router-link></li>
  <li class="list-group-item"><router-link class="" to="/oath/sendsms">Disseminate</router-link></li>
</ul>
       <!-- layer one -->
    </div>
